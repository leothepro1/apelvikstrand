(function () {
  ...
  var sektion73HeavyMapsSrc =
    "https://apelvikstrand.pages.dev/apelvikstrand.maps.js";
  ...
  function sektion73EnsureOverlayDom() {
    ...
    poster.innerHTML =
      '<div class="sektion73LottieSpinner" aria-hidden="true"></div>';
  ...
  function sektion73MountLottiePlayer() {
    ...
    sektion73LoadScript(sektion73LottieModuleSrc, function () {
      var overlay = document.getElementById(sektion73OverlayId);
      if (!overlay) return;
